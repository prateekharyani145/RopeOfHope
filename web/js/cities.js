...
function validpass()
    {
        ...
        var mobnum=document.getElementById("vmob").value;
        var vfname=document.getElementById("vfname1").value;
        var vlname=document.getElementById("vlname1").value;
        var q=document.getElementById("q").value;
        var prof=document.getElementById("p").value;
		var pcode=document.getElementById("pcode").value;
		var vs=document.getElementById("vs").value;

		if(pass.value===cpass.value)
        {
            if(mob(mobnum)  && name(vfname,vlname) && qualification(q) && Profession(prof) && postal(pcode) && Street(vs) )
                return true;
            else
                return false;
        }
        ...
        {
            var err=document.getElementById("cpasserr");
            err.style.display="block";
            err.style.border="solid 1px red";
            err.innerHTML="Password Doesn't Match";
            return false;
		}

		//Street Validation
		function Street(str1)
		{
			var c=/[0-9A-Za-z][a-zA-Z][^#&<>\"~;$^%{}@#?]+$/g;
			if(str1.match(c) && str1.length>7)
				return true;
			else
			{
				var err=document.getElementById("streeterr");
            	err.style.display="block";
            	err.style.border="solid 1px red";
            	err.innerHTML="Enter Valid Address.Don't Use Special Symbols in address.";
            	return false;
		...
		function postal(code)
		{
			...
			{
				var err=document.getElementById("pcodeerr");
            	err.style.display="block";
            	err.style.border="solid 1px red";
            	err.innerHTML="Enter Valid Postal Code";
            	return false;
        ...
        //qualification and profeesion validation
        function qualification(q1)
        {
            var c=/[0-9]|\`|\~|\!|\@|\#|\$|\%|\^|\&|\*|\(|\)|\+|\=|\[|\{|\]|\}|\||\\|\'|\<|\,|\.|\>|\?|\/|\""|\;|\:|\s/g;
            if(!q1.match(c))
                return true;
            ...
            {
                var err=document.getElementById("qualierr");
                err.style.display="block";
                err.style.border="solid 1px red";
                err.innerHTML="No special Symbol";
                return false;
            }
        }

        function Profession(p1)
        {
            var c=/[0-9]|\`|\~|\!|\@|\#|\$|\%|\^|\&|\*|\(|\)|\+|\=|\[|\{|\]|\}|\||\\|\'|\<|\,|\.|\>|\?|\/|\""|\;|\:|\s/g;
            if(!p1.match(c))
                return true;
            ...
            {
                var err=document.getElementById("profierr");
                err.style.display="block";
                err.style.border="solid 1px red";
                err.innerHTML="No special Symbol";
                return false;
        ...
        function name(fname,lname)
        {
            ...
            if(fname.length>=3 && lname.length>=3 && !fname.match(c) && !lname.match(c))
                return true;
            else
            {
       ...
       //Mobile number validation function
        function mob(mob)
        {
            ...
            {
                var err=document.getElementById("moberr");
                err.style.display="block";
                err.style.border="solid 1px red";
                err.innerHTML="Enter valid number";
                return false;
            }
        }
